// Code generated by the Encore v1.53.2 client generator. DO NOT EDIT.
...
/**
 * Client is an API client for the inventory-management-dashboard-psfi Encore application.
 */
export class Client {
    public readonly announcement: announcement.ServiceClient
    public readonly item: item.ServiceClient
    public readonly lov: lov.ServiceClient
 ...
 */
import { create as api_announcement_create_create } from "~backend/announcement/create";
import { list as api_announcement_list_list } from "~backend/announcement/list";
...
import { list as api_item_list_list } from "~backend/item/list";
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { create as api_lov_create_create } from "~backend/lov/create";
import { list as api_lov_list_list } from "~backend/lov/list";
import { update as api_lov_update_update } from "~backend/lov/update";
...
export namespace lov {
    ...
    export class ServiceClient {
        ...
        public async create(params: RequestType<typeof api_lov_create_create>): Promise<ResponseType<typeof api_lov_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/lovs`, { method: "POST", body: JSON.stringify(params) })
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_lov_create_create>
        }

        public async list(params: { category: string }): Promise<ResponseType<typeof api_lov_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/lovs/bycategory/${encodeURIComponent(params.category)}`, { method: "GET", body: undefined })
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_lov_list_list>
        }

        public async update(params: RequestType<typeof api_lov_update_update>): Promise<ResponseType<typeof api_lov_update_update>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
                value: params.value,
            }
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_lov_update_update>
        }
    }
}
...
export namespace purchase {
    ...
    export class ServiceClient {
         ...
         */
        public async approve(params: RequestType<typeof api_purchase_approve_approve>): Promise<ResponseType<typeof api_purchase_approve_approve>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
         ...
         */
        public async list(params: RequestType<typeof api_purchase_list_list>): Promise<ResponseType<typeof api_purchase_list_list>> {
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { list as api_sale_list_list } from "~backend/sale/list";
import { register as api_sale_register_register } from "~backend/sale/register";
